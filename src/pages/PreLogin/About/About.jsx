            ...
            <main className="flex-grow-1" aria-labelledby="about-heading">
                <Container>
                    ...
                    <section aria-labelledby="values-heading" className="mb-4">
                        ...
                        <p>
                            We encourage thoughtful sharing and reactions without drawn-out threads or debates. We like to keep things concise, focused, and impactful.
                        </p>
                    </section>
                    ...
                    <section aria-labelledby="accounts-heading" className="mb-4">
                        ...
                        <ul className="list-unstyled">
                            <li>
                                <strong>Personal accounts:</strong> Share updates and get feedback or reactions.
                            </li>
                            <li>
                                <strong>Business accounts:</strong> Share timely promotions or announcements. Messages from these accounts begin with "Ad:".
                            </li>
                            <li>
                                <strong>Organizational accounts:</strong> Private updates for group communication. This option is ideal for teachers, managers, or team leaders.
                            </li>
                        </ul>
                    </section>
