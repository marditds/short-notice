        ...
        <section aria-labelledby="contact-heading" className="contact-section my-5">
            ...
            <div className="px-md-3">
                <p className="contact__text mb-1">
                    ...
                    <i className="bi bi-chat-left-dots fs-5 ms-1" aria-hidden="true" />{' '}
                ...
                <p>
                    Thank you <span className="fs-5" role="img" aria-label="folded hands">🙏</span> for your understanding and cooperation.
                </p>

                <p className="contact__text mb-1">
                    Alternatively, you can email ShortNotice
                    <i className="bi bi-envelope fs-5 ms-1" aria-hidden="true" /> at
